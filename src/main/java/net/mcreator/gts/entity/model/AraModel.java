...
public class AraModel extends GeoModel<AraEntity> {
	@Override
	public ResourceLocation getAnimationResource(AraEntity entity) {
		return new ResourceLocation("gts", "animations/arageckolib.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(AraEntity entity) {
		return new ResourceLocation("gts", "geo/arageckolib.geo.json");
	}

	@Override
	public ResourceLocation getTextureResource(AraEntity entity) {
		return new ResourceLocation("gts", "textures/entities/" + entity.getTexture() + ".png");
	}

	@Override
	public void setCustomAnimations(AraEntity entity, long instanceId, AnimationState animationState) {

...
public class TamedTokiLayer extends GeoRenderLayer<TamedTokiEntity> {
	private static final ResourceLocation LAYER = new ResourceLocation("gts", "textures/entities/asuma_toki_glow.png");

	public TamedTokiLayer(GeoRenderer<TamedTokiEntity> entityRenderer) {
		super(entityRenderer);
	}

	@Override
	public void render(PoseStack poseStack, TamedTokiEntity animatable, BakedGeoModel bakedModel, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {

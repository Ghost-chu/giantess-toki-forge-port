...
public class TamedTokiJoinTheWorldProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, Entity entity) {
		if (entity == null)
			return;
		if (!world.isClientSide() && entity instanceof TamedTokiEntity) {
			...
			if (!((entity instanceof TamedTokiEntity _datEntS ? _datEntS.getEntityData().get(TamedTokiEntity.DATA_AnimationDecision) : "").equals("Toki.sleep"))
					&& !((entity instanceof TamedTokiEntity _datEntS ? _datEntS.getEntityData().get(TamedTokiEntity.DATA_AnimationDecision) : "").equals("Toki.sit"))) {

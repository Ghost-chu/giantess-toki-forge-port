...
public class AraLowerVore1Procedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, Entity sourceentity) {
		...
		if (sourceentity instanceof AraEntity _datEntSetS)
			_datEntSetS.getEntityData().set(AraEntity.DATA_AnimationDecision, "Ara.LowNom1");
		...
		GtsMod.queueServerWork(180, () -> {
			if ((entity.getVehicle()) == sourceentity && sourceentity.isAlive() && entity.isAlive()) {
				...
				AraLowerVore1EndProcedure.execute(world, x, y, z, sourceentity);
			} else if (sourceentity.isAlive() && !((sourceentity instanceof AraEntity _datEntS ? _datEntS.getEntityData().get(AraEntity.DATA_AnimationDecision) : "").equals("Ara.PreyEscape2")) && sourceentity.getPersistentData()

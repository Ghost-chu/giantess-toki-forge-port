...
public class TamedAraLowerVore1Procedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, Entity sourceentity) {
		...
		if (sourceentity instanceof TamedAraEntity _datEntSetS)
			_datEntSetS.getEntityData().set(TamedAraEntity.DATA_AnimationDecision, "Ara.LowNom1");
		...
		GtsMod.queueServerWork(65, () -> {
			if ((entity.getVehicle()) == sourceentity && sourceentity.isAlive()) {
				...
				if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
					_entity.addEffect(new MobEffectInstance(GtsModMobEffects.GTS_SHRINK_EFFECT.get(), 115, 0));
			}
		});
		GtsMod.queueServerWork(115, () -> {
			if ((entity.getVehicle()) == sourceentity && sourceentity.isAlive()) {
				if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
					_entity.addEffect(new MobEffectInstance(GtsModMobEffects.GTS_SHRINK_EFFECT.get(), 65, 1));
			}
		});
		GtsMod.queueServerWork(180, () -> {
			if ((entity.getVehicle()) == sourceentity && sourceentity.isAlive() && entity.isAlive()) {
				...
				TamedAraLowerVore1EndProcedure.execute(world, x, y, z, sourceentity);
			} else if (sourceentity.isAlive() && !((sourceentity instanceof TamedAraEntity _datEntS ? _datEntS.getEntityData().get(TamedAraEntity.DATA_AnimationDecision) : "").equals("Ara.PreyEscape2")) && sourceentity.getPersistentData()

...
public class TamedGtsSizeIncreaseProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		...
		if (!world.isClientSide() && !(new Object() {
			...
			if ((entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(Items.GOLDEN_APPLE)) : false) || new Object() {
				...
				if ((TargetEntity instanceof LivingEntity _livingEntity8 && _livingEntity8.getAttributes().hasAttribute(GtsAttributes.SCALE.get()) ? _livingEntity8.getAttribute(GtsAttributes.SCALE.get()).getBaseValue() : 0) <= 15) {
				...
				if (entity instanceof Player _player && !_player.level().isClientSide())
					_player.displayClientMessage(Component.literal("You need a golden apple in your inventory!"), false);
			}
		}
	}
}

...
public class TokiJoinTheWorldProcedure {
	...
	private static void execute(@Nullable Event event, LevelAccessor world, Entity entity) {
		if (entity == null)
			return;
		if (!world.isClientSide() && entity instanceof TokiEntity) {
			...
			if ((entity instanceof TokiEntity animatable ? animatable.getTexture() : "null").equals("asuma_toki_spawn")) {
				...
				GtsMod.queueServerWork(35, () -> {
					if (entity instanceof TokiEntity animatable)
						animatable.setTexture("asuma_toki_1");
				});

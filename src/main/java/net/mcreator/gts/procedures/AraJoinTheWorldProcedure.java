...
public class AraJoinTheWorldProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, Entity entity) {
		if (entity == null)
			return;
		if (!world.isClientSide() && entity instanceof AraEntity) {
			...
			if ((entity instanceof AraEntity animatable ? animatable.getTexture() : "null").equals("araspawntexture")) {
				if (entity instanceof Mob _mobSetNoAi) {
					_mobSetNoAi.setNoAi(true);
				}
				GtsMod.queueServerWork(10, () -> {
					if (entity instanceof AraEntity animatable)
						animatable.setTexture("aratexture");
				});

...
public class AraSpawnConditionProcedure {
	public static boolean execute(LevelAccessor world, double x, double y, double z) {
		if ((world.getBiome(BlockPos.containing(x, y, z)).is(TagKey.create(Registries.BIOME, new ResourceLocation("minecraft", "is_overworld"))) ? world.canSeeSkyFromBelowWater(BlockPos.containing(x, y, z)) : true)
				...
				&& (GtsModVariables.MapVariables.get(world).DisableGtsBiomeSpawn ? true : world.getBiome(BlockPos.containing(x, y, z)).is(TagKey.create(Registries.BIOME, new ResourceLocation("minecraft", "is_end"))))
